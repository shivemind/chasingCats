    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown menu */}
          <div className="absolute right-0 top-full mt-2 z-50 w-48 rounded-xl border border-night/10 bg-white p-2 shadow-lg">
            <div className="flex items-center justify-between mb-2 px-2 pb-2 border-b border-night/10">
              <span className="text-xs font-semibold text-night">Share to</span>
              <button 
                onClick={() => setIsOpen(false)}
            ...
            {canNativeShare && (
              <button
                ...
                className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-night/80 hover:bg-night/5 transition-colors"
              >
