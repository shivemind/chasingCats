...
export function Footer() {
  return (
    <footer className="relative mt-0 border-t border-white/10 bg-gradient-to-b from-deep-space to-night text-white" role="contentinfo">
      {/* Decorative elements */}
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <a 
                href="https://twitter.com/chasingcatsclub" 
                aria-label="Follow us on Twitter"
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-white/50 transition hover:border-neon-cyan/50 hover:text-neon-cyan focus:outline-none focus:ring-2 focus:ring-neon-cyan focus:ring-offset-2 focus:ring-offset-night"
              >
              ...
              <a 
                href="https://instagram.com/chasingcatsclub" 
              ...
              <a 
                href="https://youtube.com/@chasingcatsclub" 
                aria-label="Subscribe on YouTube"
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-white/50 transition hover:border-neon-cyan/50 hover:text-neon-cyan focus:outline-none focus:ring-2 focus:ring-neon-cyan focus:ring-offset-2 focus:ring-offset-night"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <form className="mt-4" aria-label="Newsletter signup">
              <div className="flex gap-2">
                ...
                <input
                  ...
                  required
                  className="flex-1 rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder:text-white/30 transition focus:border-neon-cyan focus:outline-none focus:ring-2 focus:ring-neon-cyan"
                />
                <button
                  type="submit"
                  className="rounded-xl bg-gradient-to-r from-neon-cyan to-brand px-4 py-2.5 text-sm font-semibold text-night transition hover:shadow-glow focus:outline-none focus:ring-2 focus:ring-neon-cyan focus:ring-offset-2 focus:ring-offset-night"
                >
                  Join
                </button>
              </div>
